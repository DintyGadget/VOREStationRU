...
/datum/antagonist/mercenary
	...
	leader_welcome_text = "Вы - лидер ударного отряда наемников; приветствую начальника. Используйте :t, чтобы поговорить со своими подчиненными."
	welcome_text = "Для выступления по личному каналу ударной группы используйте :t."
