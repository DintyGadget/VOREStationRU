...
/datum/game_mode/calamity
	...
	extended_round_description = "Весь ад вот-вот вырвется на свободу. Буквально каждый тип антагониста может появиться в этом раунде. Держись крепче."
	config_tag = "calamity"
	required_players = 1
	votable = 0
...
/datum/game_mode/calamity/check_victory()
	to_world("<font size = 3><b>Этот ужасный, ужасный день наконец-то закончился!</b></font>")
