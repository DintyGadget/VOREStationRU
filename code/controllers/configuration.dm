...
//	var/static/enable_authentication = 0		// goon authentication
	...
	var/static/list/engine_map = list("Supermatter Engine", "Edison's Bane", "R-UST Engine", "Singularity Engine")	// Comma separated list of engines to choose from.  Blank means fully random.
