...
/datum/category_item/player_setup_item/loadout/content()
	...
	. += "<tr><td colspan=3><center><a href='?src=\ref[src];prev_slot=1'>\<\<</a><b><font color = '[fcolor]'>\[[pref.gear_slot]\]</font> </b><a href='?src=\ref[src];next_slot=1'>\>\></a><b><font color = '[fcolor]'>[total_cost]/[MAX_GEAR_COST]</font> потрачено очков предметов.</b> \[<a href='?src=\ref[src];clear_loadout=1'>Очистить предметы</a>\]</center></td></tr>"
