...
/datum/gear/uniform/job_skirt/sci
	allowed_roles = list("Директор исследований","Ученый", "Ксенобиолог", "Ксеноботаник")
...
/datum/gear/uniform/job_khi/med
	display_name = "Униформа KHI: Медик"
...
/datum/gear/uniform/job_khi/sci
	display_name = "Униформа KHI: Ученый"
	path = /obj/item/clothing/under/rank/khi/sci
	allowed_roles = list("Директор исследований", "Ученый", "Роботехник", "Ксенобиолог", "Ксеноботаник", "Первопроходец", "Искатель")
...
/datum/gear/suit/job_fed/medsci
	display_name = "Униформа Федерации: Медик, Ученый"
	path = /obj/item/clothing/suit/storage/fluff/fedcoat/fedblue
	allowed_roles = list("Главврач","Медик","Химик","Парамедик","Geneticist","Директор исследований","Ученый", "Роботехник", "Ксенобиолог","Ксеноботаник","Первопроходец","Искатель","Военврач")
...
/datum/gear/uniform/job_trek/medsci/tos
	display_name = "Униформа TOS: Медик, Ученый"
...
/datum/gear/uniform/job_trek/medsci/tng
	display_name = "Униформа TNG: Медик, Ученый"
...
/datum/gear/uniform/job_trek/medsci/voy
	display_name = "Униформа VOY: Медик, Ученый"
...
/datum/gear/suit/job_trek/ds9_coat
	...
	allowed_roles = list("Глава безопасности","Директор колонии","Глава персонала","Главный инженер","Директор исследований",
						...
						"Ученый","Роботехник","Ксенобиолог","Ксеноботаник","Атмосферный техник",
...
/datum/gear/uniform/job_trek/medsci/ds9
	display_name = "Униформа DS9: Медик, Ученый"
...
/datum/gear/uniform/job_trek/medsci/ent
	display_name = "Униформа ENT: Медик, Ученый"
