...
/datum/gear/fluff/jeremiah_holster
	...
	allowed_roles = list("Директор колонии", "Надзиратель", "Глава службы безопасности")
...
/datum/gear/fluff/kateryna_armorvest
	...
	ckeywhitelist = list("samanthafyre")
	character_name = list("Kateryna Petrovitch")
	allowed_roles = list("Офицер безопасности", "Надзиратель", "Глава службы безопасности", "Директор колонии", "Глава персонала")
...
/datum/gear/fluff/tempest_hudglases
	...
	allowed_roles = list("Главврач","Врач","Химик","Психиатр","Парамедик", "Военврач", "Off-duty Medic")
