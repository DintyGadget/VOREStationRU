...
/datum/category_item/player_setup_item/vore/misc/content(var/mob/user)
	. += "<br>"
	. += "<b>Отображать в Character Directory:</b> <a [pref.show_in_directory ? "class='linkOn'" : ""] href='?src=\ref[src];toggle_show_in_directory=1'><b>[pref.show_in_directory ? "Да" : "Нет"]</b></a><br>"
	. += "<b>Предпочитаемая настройка сенсоров:</b> <a [pref.sensorpref ? "" : ""] href='?src=\ref[src];toggle_sensor_setting=1'><b>[sensorpreflist[pref.sensorpref]]</b></a><br>"	//TFF 5/8/19 - Allow selection of sensor settings from off, binary, vitals, tracking, or random
...
/datum/category_item/player_setup_item/vore/misc/OnTopic(var/href, var/list/href_list, var/mob/user)
	...
	//TFF 5/8/19 - add new thing so you can choose the sensor setting your character can get.
		...
		var/new_sensorpref = input(user, "Выберите предпочитаемую настройку сенсоров персонажа", "Character Preferences", sensorpreflist[pref.sensorpref]) as null|anything in sensorpreflist
