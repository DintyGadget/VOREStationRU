...
/datum/category_item/player_setup_item/vore/ears/content(var/mob/user)
	...
	if(ear_styles_list[pref.ear_style])
		...
		if(ear.do_colouration)
			. += "<a href='?src=\ref[src];ear_color=1'>Основной цвет цвет</a> [color_square(pref.r_ears, pref.g_ears, pref.b_ears)]<br>"
		if(ear.extra_overlay)
			. += "<a href='?src=\ref[src];ear_color2=1'>Вторичный цвет</a> [color_square(pref.r_ears2, pref.g_ears2, pref.b_ears2)]<br>"
		if(ear.extra_overlay2)
			. += "<a href='?src=\ref[src];ear_color3=1'>Третичный цвет</a> [color_square(pref.r_ears3, pref.g_ears3, pref.b_ears3)]<br>"
	...
	if(tail_styles_list[pref.tail_style])
		...
		if(T.do_colouration)
			. += "<a href='?src=\ref[src];tail_color=1'>Основной цвет</a> [color_square(pref.r_tail, pref.g_tail, pref.b_tail)]<br>"
		if(T.extra_overlay)
			. += "<a href='?src=\ref[src];tail_color2=1'>Вторичный цвет</a> [color_square(pref.r_tail2, pref.g_tail2, pref.b_tail2)]<br>"
		if(T.extra_overlay2)
			. += "<a href='?src=\ref[src];tail_color3=1'>Третичный цвет</a> [color_square(pref.r_tail3, pref.g_tail3, pref.b_tail3)]<br>"
	...
	if(wing_styles_list[pref.wing_style])
		...
		if (W.extra_overlay)
			. += "<a href='?src=\ref[src];wing_color2=1'>Вторичный цвет</a> [color_square(pref.r_wing2, pref.g_wing2, pref.b_wing2)]<br>"
		if (W.extra_overlay2)
			. += "<a href='?src=\ref[src];wing_color3=1'>Вторичный цвет</a> [color_square(pref.r_wing3, pref.g_wing3, pref.b_wing3)]<br>"
