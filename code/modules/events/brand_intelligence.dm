/datum/event/brand_intelligence
	...
	var/list/rampant_speeches = list("Попробуйте наши новые агрессивные маркетинговые стратегии!", \
									 ...
									 "Вы не хотите ничего покупать? Да, твоя мамка тоже тот еще товар.")
	//VORESTATION Edit End

/datum/event/brand_intelligence/announce()
	command_announcement.Announce("На [station_name()], была обнаружена постоянная массовая загрузка \
	вредоносного ПО для автоматов продажи, которое, похоже, передается другим ближайшим машинам.  Предполагается, что первая зараженная машина была: [originMachine.name].", "Vendor Service Alert")
