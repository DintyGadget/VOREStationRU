var/list/department_radio_keys = list(
	  ...
	  ":с" = "Командование",		".с" = "Командование",
	  ":т" = "Научный отдел",		".т" = "Научный отдел",
	  ":ь" = "Медицинский отдел",		".ь" = "Медицинский отдел",
	  ":у" = "Инженерный отдел",	".у" = "Инженерный отдел",
	  ":ы" = "Служба безопасности",	".ы" = "Служба безопасности",
	  ":ц" = "whisper",		".ц" = "whisper",
	  ":е" = "Mercenary",	".е" = "Mercenary",
	  ":й" = "Снабжение",		".й" = "Снабжение",
)
