...
/proc/AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, rank)
	...
	if(rank == "Heads")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Глава персонала")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Директор колонии")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Глава службы безопасности")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Главный инженер")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Директор исследований")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Главврач")
		return 1
	if(rank == "Служба безопасности")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Глава службы безопасности")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Надзиратель")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Детектив")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Офицер безопасности")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Киборг")
		return 1
	if(rank == "Инженерный отдел")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Инженер")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Атмосферный техник")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Главный инженер")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Киборг")
		return 1
	if(rank == "Research")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Учёный")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Geneticist")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Главврач")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Директор исследований")
		return 1
	if(rank == "Медицинский отдел")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Geneticist")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Врач")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Главврач")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Химик")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Киборг")
		return 1
	...
	if(rank == "CE_Shaft_Miner")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Шахтёр")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Главный инженер")
		return 1
	...
	if(rank == "AI_Cyborg")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Киборг")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "ИИ")
		return 1
	...
	if(rank == "Virologist_RD_CMO")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Главврач")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Директор исследований")
		AddBanjob(ckey, computerid, reason, bannedby, temp, minutes, "Вирусолог")
		return 1
