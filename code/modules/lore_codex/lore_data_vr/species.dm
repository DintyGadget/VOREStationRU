...
/datum/lore/codex/category/positronic/add_content()
	...
	half-discovered in the 2280ís by a human black lab studying alien artifacts, the first positronic brain was an inch-wide cube \
...
/datum/lore/codex/page/codeline
	...
	codelineís initial state or from a fully realized individual of that codeline. The degree of similarity between forks of the same codeline varies \
...
/datum/lore/codex/page/emergent_intelligence_oversight
	...
	groups bristle at the EIOís human-centric viewpoint, but most are glad to have a different boogeyman in the form of drone intelligences. The tiny population \
	of A-class drones are generally frightened of the EIOís total power over them."
...
/datum/lore/codex/page/class_a/add_content()
	...
	first principles, with an incredible potential for growth and emergent behavior. However, some abilities fall short of humansí, usually those relating \
...
/datum/lore/codex/page/class_aa
	...
	will jokingly refer to themselves or other organics and positronics as AAís. Research into brain uploading is heavily regulated and generally illegal."
